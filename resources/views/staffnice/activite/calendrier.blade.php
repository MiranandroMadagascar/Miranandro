        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('activite.director.calendrier') }}" method="GET" class="mb-3">
                                        ...
                                        <tbody>
                                            @forelse($activites as $activite)
                                                <tr class="table-info">
                                                    ...
                                                    <td>
                                                        <a href="{{ route('activite.calendrier.director.details', ['id_activite' => $activite->id_activite]) }}" class="btn btn-info btn-sm">
