...
<div class="container">
    ...
    @if($activite)
        ...
        <a href="{{ route('activite.export.pdf', ['id_activite' => $activite->id_activite]) }}" class="btn btn-primary">Export PDF</a>
        <a href="{{ route('activite.calendrier') }}" class="btn btn-secondary">Retour</a>
    @else
