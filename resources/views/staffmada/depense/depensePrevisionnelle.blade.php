...
@section('title', 'Dépenses prévisionnelles')
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" id="depense-container" method="POST" action="{{ route('depensesPrevisionnels.inserer', ['id_fiche_technique' => $id_fiche_technique]) }}">
                        @csrf
